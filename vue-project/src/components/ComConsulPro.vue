<template>
    ...
    <div class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <div v-if="producto" id="container" @click="closeModal">
          <h3>Información del Productp</h3>
  ...
  const handleSubmit = async () => {
    ...
    try {
      const respuesta = await axios.get(`http://127.0.0.1:8000/productos/${idProducto.value}`); // Endpoint ajustado
      producto.value = respuesta.data; // Asigna los datos del empleado
    } catch (error) {
