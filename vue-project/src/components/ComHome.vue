...
>>>>>>> master
    ...
    text-decoration: none;
    overflow: hidden;
    background: linear-gradient(to bottom, #D9AB23, #D9AB23);
    margin-top: -213px;
    margin-left: 780px;
  }
  .card2 {
    ...
    text-decoration: none;
    overflow: hidden;
    background: linear-gradient(to bottom, #A65814, #A65814);
    margin-top: -178px;
    margin-left: 1030px;
  }
  .card3 {
