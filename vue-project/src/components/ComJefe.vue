...
<template>
 ...
 <div v-if="mostrarModal" class="modal-overlay">
   ...
   <section id="c">
     ...
     <p id="vis">En esta sección, como jefe de la cafetería, podrás acceder a toda la información relacionada con tus empleados. Puedes ver el listado completo de personal. Esta herramienta te permite gestionar y consultar, actualizar, eliminar la información de los empleados para mantener un ambiente de trabajo optimizado. Es esencial que tengas acceso a estos datos para tomar decisiones informadas y garantizar el buen funcionamiento de la cafetería.</p>
...
.alert-config-container2 {
        ...
        padding: 20px;
        border-radius: 30px; /* Bordes redondeados en la parte superior */
